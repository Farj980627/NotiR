...
var apiKey = src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiKey;
var apiUrl = src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl;
...
var NoticiasService = /** @class */ (function () {
    ...
    NoticiasService.prototype.getNoticiasCat = function (category) {
        var pagen = 0;
        ...
        pagen = this.page * 5;
        return this.llamarAPI('/top-headlines?country=us&category=' + category + '&pageSize=5&page=' + pagen);
    };
    NoticiasService.prototype.getNoticiasSources = function (fuente) {
        return this.querySource('/top-headlines?sources=' + fuente);
    };
    NoticiasService.prototype.querySource = function (query) {
        query = apiUrl + query;
        return this.http.get(query, { headers: headers });
    };
    NoticiasService.prototype.getNoticiasEv = function (search) {
        var pagen = 0;
        this.page += 1;
        pagen = this.page + 1;
        return this.llamarAPI('/everything?q=' + search + '&pageSize=5&page=' + pagen);
    };
    NoticiasService.prototype.getSources = function () {
        var pagen = 0;
        this.page += 1;
        pagen = this.page + 1;
        return this.llamarAPI('/sources?&page=' + pagen);
    };
